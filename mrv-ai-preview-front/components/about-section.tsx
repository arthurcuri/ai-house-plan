    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">O que é o MRV AI Preview?</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            O MRV AI Preview é uma ferramenta revolucionária que transforma plantas baixas simples em visualizações
